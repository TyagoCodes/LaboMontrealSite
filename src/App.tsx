    ...
    return (
        <>
            ...
            <div className="grid grid-flow-col grid-rows-3 gap-4">
                ...
                <div className="block w-[350px] h-[150px] col-span-2 rounded-lg shadow-sm bg-gray-800 p-6">
                    <h1>Subscribe to alerts</h1>
                    <p>To receive notices and alerts by e-mail or text message, you must create an account.</p>
                    <a href="/subcriptionLink" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Subscribe
            ...
            {/*  Footer  */}
            <footer className="bg-neutral-700 py-8 px-26">
                <div className="flex flex-col gap-y-4">
